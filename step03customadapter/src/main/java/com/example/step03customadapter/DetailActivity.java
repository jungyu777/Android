...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //DetailActivity 가 활성화 되기 위해서 전달된 Intent객체의 참조값 얻어내기
        ...
        //선택된 cell 에 해당하는 CounterDto가 있다면
        //아래의 ImageView 와 TextView에 해당 정보를 출력할수 있다
        ...
        //확인버튼을 눌렀을떄 액티비티 종료까지
        Button comfirmBtn = findViewById(R.id.confirmBtn);
        //finisg() 메소드를 호출하면 액티비티가 종료된다.
        comfirmBtn.setOnClickListener(view -> {finish();});
    }
}